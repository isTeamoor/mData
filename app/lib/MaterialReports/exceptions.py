...
extra = {
    ...
    'rmpd':{
        ...
        'currentMonth':[
            {'Код товара':'29422','Reservation Number':-4,'WO №':-4,'closedMonth':0,'closedYear':0,'Work Order Status Description':'Open','Материал':"Алюмин 14",'Ед.изм.':'т','Quantity':0.001,'Отдел':'rmpd','Reserved By':"Metall",'Asset Description':'Metall', 'Объект':'Metall'},
            ...
            {'Код товара':'21883','Reservation Number':-6,'WO №':-6,'closedMonth':0,'closedYear':0,'Work Order Status Description':'Open','Материал':"Алюмин 14",'Ед.изм.':'т','Quantity':0.001,'Отдел':'rmpd','Reserved By':"Metall",'Asset Description':'Metall', 'Объект':'Metall'},
