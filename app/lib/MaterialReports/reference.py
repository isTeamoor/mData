...
department_Filters = {
    'rmpd': [
        ...
        [
            ...
            "&",
            {"field": 'Материал', "operator": "!=","value": "'Специальная форменная одежда ГОСТ 27575-87'"},
            "&",
            {"field": 'Материал', "operator": "!=","value": "'Полуботинки GATOR со шнурком для ИТР ,ГОСТ 28507-99 UzTR.5-011:2017*'"},
            "&",
            {"field": 'Материал', "operator": "!=","value": "'Перчатки для точечных работ'"},
            "&",
            {"field": 'Материал', "operator": "!=","value": "'Спец.обувь мужские для рабочих,ГОСТ 28507-99,UzTR.5-011:2017*'"},
            "&",
            {"field": 'Материал', "operator": "!=","value": "'Куртка мужская с логотипом'"},
            "&",
            {"field": 'Материал', "operator": "!=","value": "'Спец.обувь мужские для рабочих,ГОСТ 28507-99'"},
            "&",
            {"field": 'Материал', "operator": "!=","value": "'Очки защитные VULCANO2 SMOKE'"},
        ],        
    ],
...
is_014 = ['06935', '05841', '07139', '05230', '04189', '03494', '02799', '05749', '01738', '01308', '01309', '01310', '01311', '01312', '01329', '01330', '01331', '01333', '01351', '01354', '01372', '01374', '01376',
          ...
          '08008', '03014', '06326', '09297', '00704', '05824', '09605', '09606', '12414', '09608', '01517', '02838', '11063', '02794', '10518', '12500', '27290', '24631', '06304', '06331', '12497', '12499', '19400', '09332',
          '01572', '01585', '30445', '05318',
...
is_wOff = ['09327', '09326', '07483', '12478', '09859',
           '07536', '05328', '06949', '09607', '16801', '09360', '11316',]
