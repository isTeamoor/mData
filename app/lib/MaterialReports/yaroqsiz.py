...
def custom_exceptions(inputDF):
    ...
    df.loc[ (df['Номер документа'] == 'ORD-048/71-2025') & (df['№'] == '1'),  'Код товара' ] = 'WIM0066339'
    df.loc[ (df['Номер документа'] == 'ORD-048/71-2025') & (df['№'] == '1'),  'Количество (из акта)' ] = 5
    df.loc[ (df['Номер документа'] == 'ORD-048/71-2025') & (df['№'] == '2'),  'Код товара' ] = 'WIM0066338'

    df.loc[ (df['Номер документа'] == 'ORD-048/72-2025') & (df['№'] == '1'),  'Код товара' ] = 'WIM0066339'
    df.loc[ (df['Номер документа'] == 'ORD-048/72-2025') & (df['№'] == '1'),  'Количество (из акта)' ] = 4
    df.loc[ (df['Номер документа'] == 'ORD-048/72-2025') & (df['№'] == '2'),  'Код товара' ] = 'WIM0066338'

    df.loc[ df['Номер документа'].isin(['ORD-048/75-2025','ORD-048/75-2025','ORD-048/75-2025',
                                         'ORD-048/75-2025','ORD-048/75-2025','ORD-048/75-2025',
                                         'ORD-048/75-2025','ORD-048/75-2025',]) ,  'Количество (из акта)' ] = 1
...
notMet =['05116', '05120', '05127', '05258', '05274', '05843', '09301', '09318', '09356', 
            ...
            '09323','09586','17016','22591','02907','06801','13223',]
