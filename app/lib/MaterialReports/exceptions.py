...
extra = {
    ...
    'cofe':{
        'begin':[
            {'Код товара':'06933','Reservation Number':-1,'WO №':-1,'closedMonth':9,'closedYear':2024,'Work Order Status Description':'Closed','Материал':"Дизельное топливо",'Ед.изм.':'л','Quantity':50,'Отдел':'CofE','Reserved By':"CofE",'Asset Description':'Diesel', 'Объект':'Diesel'},
        ],
        'currentMonth':[
