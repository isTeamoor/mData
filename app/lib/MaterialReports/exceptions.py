                                                         33203,32450,32514,31640,31809,31810,31811,31813,
                                                         ...
                                                         31850,31851,31852,31943,31944,31945,31946,31947,31948,
                                                         31949,31950,31959,32764,33221,32558,32927,32795,32237,
                                                         32238,32239,]), 'Work Order Status Description' ] = 'Closed'
    transacts.loc[ transacts['Reservation Number'].isin([33082,33081,33074,33080,32212,31354,33209,28115,33168,
                                                         33169,33173,32771,27827,27829,27577,30344,27795,27826,
                                                         27011,27033,27575,27820,30343,27587,30346,27584,27828,
                                                         27585,30350,27586,30349,27579,30352,30345,32695,32049,
...
extra = {
    ...
    'rmpd':{
        'begin':[
            #Met
            {'Код товара':'12814','Reservation Number':-1,'WO №':-1,'closedMonth':0,'closedYear':0,'Work Order Status Description':'NotClosed','Материал':"Алюминий",'Ед.изм.':'кг','Quantity':0.7,'Отдел':'rmpd','Reserved By':"Metall",'Asset Description':'Metall', 'Объект':'Metall'},
        ...
        'currentMonth':[
            #Бумага
            {'Код товара':'06944','Reservation Number':-4,'WO №':-4,'closedMonth':12,'closedYear':2025,'Work Order Status Description':'Closed','Материал':"Бумага А4 SvetaCopy 80гр. В пачке 500 листов",'Ед.изм.':'пачка','Quantity':6,'Отдел':'rmpd','Reserved By':"rmpd",'Asset Description':'Бумага', 'Объект':'Бумага'},
    ...
    'cofe':{
        'begin':[
            ...
            {'Код товара':'06933','Reservation Number':-3,'WO №':-3,'closedMonth':12,'closedYear':2025,'Work Order Status Description':'Closed','Материал':"Дизельное топливо GTL",'Ед.изм.':'л','Quantity':25,'Отдел':'CofE','Reserved By':"CofE",'Asset Description':'Diesel', 'Объект':'Diesel'},
        ...
        'currentMonth':[
            ...
            {'Код товара':'36104','Reservation Number':-701,'WO №':-701,'closedMonth':12,'closedYear':2025,'Work Order Status Description':'Closed','Материал':"Туалетная бумага Elma Panda Asian pack Econom 6 шт",'Ед.изм.':'упаковка','Quantity':15,'Отдел':'CofE','Reserved By':"CofE",'Asset Description':'Хозтовары', 'Объект':'Хозтовары'},
            {'Код товара':'36885','Reservation Number':-702,'WO №':-701,'closedMonth':12,'closedYear':2025,'Work Order Status Description':'Closed','Материал':"Бумажные салфетки Elma Z ECO для дисп. 180 шт. (243)",'Ед.изм.':'упаковка','Quantity':15,'Отдел':'CofE','Reserved By':"CofE",'Asset Description':'Хозтовары', 'Объект':'Хозтовары'},
            ...
            #Diesel
            {'Код товара':'06933','Reservation Number':-6,'WO №':-6,'closedMonth':12,'closedYear':2025,'Work Order Status Description':'Closed','Материал':"Дизельное топливо GTL",'Ед.изм.':'л','Quantity':566,'Отдел':'CofE','Reserved By':"CofE",'Asset Description':'Diesel', 'Объект':'Diesel'},
            {'Код товара':'06933','Reservation Number':-8,'WO №':-8,'closedMonth':0,'closedYear':2025,'Work Order Status Description':'Open','Материал':"Дизельное топливо GTL",'Ед.изм.':'л','Quantity':307,'Отдел':'CofE','Reserved By':"CofE",'Asset Description':'Diesel', 'Объект':'Diesel'},
